...
inline
int cs200::DPTexturedMesh::vertexCount(void) const {
  return 18;
}


inline
const glm::vec4* cs200::DPTexturedMesh::vertexArray(void) const {
  return dp_verts;
}


inline
glm::vec4 cs200::DPTexturedMesh::dimensions(void) const {
  return cs200::vector(12,12);
}


inline
glm::vec4 cs200::DPTexturedMesh::center(void) const {
  return cs200::point(6,6);
}


inline
int cs200::DPTexturedMesh::faceCount(void) const {
  return 12;
}


inline
const cs200::Mesh::Face* cs200::DPTexturedMesh::faceArray(void) const {
  return dp_faces;
}


inline
int cs200::DPTexturedMesh::edgeCount(void) const {
  return 18;
}


inline
const cs200::Mesh::Edge* cs200::DPTexturedMesh::edgeArray(void) const {
  return dp_edges;
}


inline
const glm::vec2* cs200::DPTexturedMesh::texcoordArray(void) const {
  return dp_texcoords;
}
